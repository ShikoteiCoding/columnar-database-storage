...
class MiniDatabaseEngine:
    ...
    def __init__(
        ...
        self.table_data_writer = table_data_writer or SingleFileTableDataWriter(
            MetadataWriter()
        )
    ...
    def create_schema(self, schema_name: str) -> None:
        ...
        raise NotImplementedError(
            "Question 9: implement MiniDatabaseEngine.create_schema()"
        )
    ...
    def create_table(
        ...
        raise NotImplementedError(
            "Question 9: implement MiniDatabaseEngine.create_table()"
        )
    ...
    def insert_rows(
        ...
        raise NotImplementedError(
            "Question 9: implement MiniDatabaseEngine.insert_rows()"
        )
